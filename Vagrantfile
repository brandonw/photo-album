...
$dependencies = <<SCRIPT
    ...
    DEBIAN_FRONTEND=noninteractive cp /vagrant/nginx /etc/nginx/sites-available/photo_album
    ...
    DEBIAN_FRONTEND=noninteractive echo "//waskiewicz-server/usb/Home /media/album cifs guest 0 0" >> /etc/fstab
